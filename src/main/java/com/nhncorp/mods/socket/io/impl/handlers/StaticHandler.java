	...
	public void handle(ClientData clientData) {
		...
		switch (fileName) {
			case "/static/flashsocket/WebSocketMainInsecure.swf":
				res.sendFile("./src/main/resources/WebSocketMainInsecure.swf");
				break;
			case "/static/flashsocket/WebSocketMain.swf":
				res.sendFile("./src/main/resources/WebSocketMain.swf");
				break;
			case "/socket.io.js":
				res.sendFile("./src/main/resources/socket.io.js");
				break;
			case "/socket.io.min.js":
				res.sendFile("./src/main/resources/socket.io.min.js");
				break;
			default:
